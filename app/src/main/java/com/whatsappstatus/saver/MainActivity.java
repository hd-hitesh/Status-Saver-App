...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_share) {
            ...
            intent.putExtra("android.intent.extra.SUBJECT", "Share New Status Saver App");
            intent.putExtra("android.intent.extra.TEXT", "Try this Awesome App 'New WhatsApp Status Saver' which helps you in Saving all the WhatsApp Statuses ..! \n LINK");
